...
def polytopic_trajectory_to_set_of_polytopes(s,x0,T,list_of_polytopes,eps=0,method="bigM"):
...
def terminal_constraint_convex_hull(s,x,G,model,list_of_polytopes):
    """
    Facts: Here we use H-rep. Therefore, G_eps is used!
    Everything is used with bigM
    """
